...
public class TradeRequest116 extends TradeRequest {

	public TradeRequest116(Player sender, Player receiver) {
	...
	public void sendInitialMessage() {
		...
		if(Options.use_commands) {
			...
			PacketPlayOutChat rpacket = new PacketPlayOutChat(ChatSerializer.b(sjson), ChatMessageType.CHAT, sender.getUniqueId());
		...
		if(Options.use_commands) {
			...
			PacketPlayOutChat spacket = new PacketPlayOutChat(ChatSerializer.b(rjson), ChatMessageType.CHAT, receiver.getUniqueId());
